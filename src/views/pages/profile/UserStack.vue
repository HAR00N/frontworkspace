              ...
              <v-timeline dense align-top class="timeline-line-color">
                ...
                >
                  <template v-slot:icon>
                    <v-avatar v-if="item.icon" size="36" color="#ffffff">
                      <v-icon
                    ...
                    <v-avatar v-if="!item.icon" size="46">
